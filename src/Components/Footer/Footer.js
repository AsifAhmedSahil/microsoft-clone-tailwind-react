...
const Footer = () => {
  ...
  return (
    ...
    <div>
        <ScrollToTop smooth top="1000"  color='black' />
        <footer class="text-center lg:text-left bg-gray-100 text-gray-600 mt-10 my-10">
  ...
  <div class="text-center p-6 bg-gray-200">
    <span>© 2022 Copyright: <strong>Asif Ahmed Sahil</strong></span>
